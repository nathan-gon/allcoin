        ...
        >
            <TableCell align="center"
                ...
                sx={{
                    ...
                    , justifyContent: 'left', marginLeft: '5px'
                }}>
            ...
            <TableCell align="right" >${addComma(coin.current_price)}  </TableCell>
            <TableCell align="right"
                sx={{ color: coin.price_change_percentage_24h < 0 ? 'red' : 'rgb(14, 203, 129)' }}
            >{round(coin.price_change_percentage_24h)}% </TableCell>
            <TableCell align="right">${addComma(coin.market_cap)}</TableCell>
            <TableCell align="right">${addComma(coin.high_24h)}</TableCell>
        </TableRow>
    )
